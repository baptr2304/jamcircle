...
<template>
  <ScrollArea class="h-[70vh] sm:h-[70vh] md:h-[90vh] xl:h-[90vh]">
    <div class="flex flex-col justify-center items-center">
      <div class="w-[90%]">
        <h1 class="text-primary text-2xl">Information</h1>
        <div class="flex items-center">
          <div class="text-xl mr-2 font-bold">{{ room.name }}</div>
          <IconPen class="w-4 h-4" />
        </div>
        <div class="mt-4">
          <div class="flex items-center">
            <h3 class="text-lg font-bold mr-2">Room ID</h3>
            <input
              type="text"
          ...
          <div>
            <h1 class="mt-6 mb-2 text-primary text-xl">Invite Link</h1>
            <div class="flex items-center">
              <input
                type="text"
          ...
          <h1 class="mt-6 text-primary text-xl">Member</h1>
          <div class="flex flex-col mt-4">
            ...
            >
              ...
              <div class="flex items-center">
                <div class="text-xs text-gray-400 mr-2">{{ member.role }}</div>
                <IconPen class="w-4 h-4" />
              </div>
            </div>
          </div>
